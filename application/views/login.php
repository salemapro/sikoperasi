...
<head>
	...
	<title>Koperasi Adira | Log in</title>
...
<style>
	...
	body {
		background: url(assets/img/latarbelakang.jpeg) no-repeat center fixed;
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h1 class="panel-title"><span class="glyphicon glyphicon-home"></span> KOPERASI PT. ADIRA SEMESTA INDUSTRY</h1>
				</div>
