...
<head>
	...
	<title>Registrasi | Koperasi</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="<?php echo base_url('Auth') ?>"><b>Koperasi</b>Adira</a>
		</div>
		...
		<div class="login-box-body">
			<p class="login-box-msg">Sign up to start the system</p>
			<form action="<?php echo base_url('Auth/add') ?>" method="post">
				...
				<div class="form-group has-feedback">
					<input name="nip" class="form-control <?php echo form_error('nip') ? 'is-invalid' : '' ?>" placeholder="Enter NIP" type="text" value="<?php echo set_value('nip'); ?>">
					<div class="invalid-feedback" style="color: red;">
						<?php echo form_error('nip') ?>
					</div>
				</div>
				<!-- <div class="form-group has-feedback">
					<input name="nama" class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>" placeholder="Enter Full Name" type="text" value="<?php echo set_value('nama'); ?>">
					<div class="invalid-feedback" style="color: red;">
				...
				<div class="row">
					...
					<div class="col-xs-4 pull-right">
						<a href="<?php echo base_url('Auth') ?>" class="btn btn-warning">Back</a>
					</div>
					<!-- /.col -->
				</div>
			</form>
