              ...
              <form role="form" action="<?php echo base_url('pengajuan/add') ?>" method="post">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input name="no_pengajuan" value="<?= $no_pengajuan ?>" class="form-control <?php echo form_error('no_pengajuan') ? 'is-invalid' : '' ?>" readonly type="text" />
                    <div class="invalid-feedback">
                      <?php echo form_error('no_pengajuan') ?>
                    </div>
                  </div>
                  <div class="form-group">
                    <label>NIP</label>
                    ...
                    <input name="sisa_kontrak" value="<?= $user->sisa_kontrak ?>" class="form-control <?php echo form_error('sisa_kontrak') ? 'is-invalid' : '' ?>" readonly type="hidden" />
                    <div class="invalid-feedback">
