...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="<?php echo base_url('Dashboard/manajer') ?>"><i class="fa fa-book"></i> <span>Dashboard</span></a></li>
      <li><a href="<?php echo base_url('Pinjaman') ?>"><i class="fa fa-fw fa-circle"></i> <span>Data Pinjaman</span></a></li>
